...
def main():  # noqa: ANN201, D103
    ...
    session = create_conversation(
        "examples/test_data/research_papers/lecun_deep_learning_ai_2021.pdf"  # noqa: COM812
    )
    ...
    followup = session.ask(
        "Which advantage would be most important for image recognition?"  # noqa: COM812
    )
    ...
    session.add_source(
        "https://www.youtube.com/watch?v=aircAruvnKk"  # noqa: COM812
    )  # Use any educational ML video URL

    # Cross-source learning with focused questions
    practical_questions = [
        "How do the theoretical concepts apply to the neural network visualization in the video?"  # noqa: COM812, E501
    ]
    ...
    session.add_source(
        "examples/test_data/research_papers/menghani_efficient_deep_learning_2021.pdf"  # noqa: COM812
    )

    # Focused synthesis question
    synthesis = session.ask(
        "What would be the most practical first step for someone starting with deep learning?"  # noqa: COM812, E501
    )
