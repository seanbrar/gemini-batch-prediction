...
def test_conversation_ask_behavior(golden, mock_gemini_client):  # noqa: ANN001, ANN201
    """
    ...
    """
    # Arrange
    sources = golden['input']['sources']  # noqa: Q000
    ...
    mock_responses = [
        {"text": json.dumps(["Answer to the first question."]), "usage_metadata": {"prompt_tokens": 50, "candidates_token_count": 10, "total_tokens": 60}},  # noqa: E501
        {"text": json.dumps(["Answer to the second question, considering the first."]), "usage_metadata": {"prompt_tokens": 70, "candidates_token_count": 15, "total_tokens": 85}},  # noqa: E501
    ]
    ...
    from gemini_batch import BatchProcessor  # noqa: PLC0415
    ...
    # Assert
    assert final_history == golden.out['final_history']  # noqa: Q000
