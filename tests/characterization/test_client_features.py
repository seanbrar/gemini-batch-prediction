...
def test_explicit_caching_behavior(golden, caching_gemini_client, mocked_internal_genai_client):
    """
    ...
    # Arrange
    large_content = "A very large piece of text content..." * 1000 # Exceeds caching threshold
    ...
    def log_generate_content(*args, **kwargs):
        ...
        if hasattr(kwargs.get('config'), 'cached_content') and kwargs.get('config').cached_content:
    ...
    mocked_internal_genai_client.models.generate_content.side_effect = log_generate_content
