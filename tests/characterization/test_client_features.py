...
def test_explicit_caching_behavior(golden, caching_gemini_client, mocked_internal_genai_client):  # noqa: ANN001, ANN201, E501
    """
    ...
    """
    _ = golden['input']  # Silence unused field warning  # noqa: Q000
    # Arrange
    large_content = "A very large piece of text content..." * 1000 # Exceeds caching threshold  # noqa: E501
    ...
    def log_generate_content(*args, **kwargs):  # noqa: ANN002, ANN003, ANN202, ARG001
        call_details = {"method": "generate_content"}
        # Check if the call is using a cache
        if hasattr(kwargs.get('config'), 'cached_content') and kwargs.get('config').cached_content:  # noqa: E501, Q000
            call_details["cached_content"] = kwargs['config'].cached_content  # noqa: Q000
        else:
    ...
    def log_cache_create(*args, **kwargs):  # noqa: ANN002, ANN003, ANN202, ARG001
    ...
    mocked_internal_genai_client.models.generate_content.side_effect = log_generate_content  # noqa: E501
    ...
    assert interaction_log == golden.out['interaction_log']  # noqa: Q000
